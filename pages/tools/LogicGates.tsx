...
interface TruthTableProps {
  gateInfo: typeof GATES[GateType];
  inputA: boolean;
  inputB: boolean;
}

const TruthTable: React.FC<TruthTableProps> = ({ gateInfo, inputA, inputB }) => {
  ...
  return (
    <div className="pt-24 pb-12 px-6 lg:px-12 max-w-5xl mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Main Canvas & Output */}
        <div className="lg:col-span-2 glass-panel p-6 rounded-2xl border border-white/10 bg-zinc-900/60 flex flex-col items-center">
