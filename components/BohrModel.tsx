    ...
    <div className="flex flex-col items-center gap-3 w-full h-full">
      ...
      <div className="flex items-center gap-3">
        <button onClick={() => setZoom(z => Math.max(0.4, +(z - 0.2).toFixed(1)))}
          className="w-8 h-8 rounded-full bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold text-xl flex items-center justify-center transition-colors">−</button>
